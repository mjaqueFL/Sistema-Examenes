...
<html lang="en">
<head>
    <title>Política Privacidad-Gestor Examenes</title>
</head>
<?php
                ...
                <article id="content">
                    ...
                    <div class="">
                        <div class="ng-binding">
                            ...
                            <strong>Identidad:</strong>Ignacio Lorenzo-Gestor Examenes<br>
                            ...
                            <strong>Correo Electrónico:</strong> ilorenzovelez.guadalupe@alumnado.fundacionloyola.net
                            <br>
                            <strong>Contacto:</strong> Ignacio<br>
                            <strong>Nombre del dominio:</strong> http://localhost/GestorExamenes/<br>
                            ...
                            <p>En cumplimiento de lo dispuesto en el Reglamento Europeo 2016/679 General de Protección
                                de
                                Datos, te informamos de que trataremos los datos que nos facilitas para:</p>
                            <ul>
                                <li>Gestionar la contratación de servicios que realice a través de la Plataforma, así
                                    como
                                ...
                                <li>Remitir información comercial y / o promocional relacionada con el sector de
                                    servicios
                                    contratados y valor añadido para usuarios finales, salvo que se indique lo contrario
                                    o
                                    el usuario se oponga o revoque su consentimiento.
                                </li>
                            ...
                            <ul>
                                ...
                                <li class="ng-binding">Datos de información comercial. En caso de que el usuario
                                    facilite
                            ...
                            <p class="ng-binding">El tratamiento de datos cuyo fin es el envío de boletines periódicos
                                ...
                                profesional se basa en el consentimiento del interesado, solicitado expresamente para
                                llevar
                                ...
                                retirar en cualquier momento, si bien ello puede afectar a la posible comunicación de
                                forma
                                fluida y obstrucción de procesos que desea realizar.<br>
                                Por último, los datos se podrán utilizar para dar cumplimiento a las obligaciones
                                legales
                                aplicables a Ignacio Lorenzo-Gestor Examenes
                            </p>
                            ...
                            <p class="ng-binding">Tus datos podrán ser accedidos por aquellos proveedores que prestan
                                ...
                                También podrán ser cedidos a las Fuerzas y Cuerpos de Seguridad del Estado en los casos
                                que
                            ...
                            <h3>
                                Seguridad de la Información – ¿Qué medidas de seguridad implantamos para cuidar sus
                                datos?
                            </h3>
                            <p>
                                Para proteger las diferentes tipologías de datos reflejados en esta política de
                                privacidad
                                llevará a cabo las medidas de seguridad técnicas necesarias para evitar su pérdida,
                                manipulación, difusión o alteración.
                            </p>
                            <ul>
                                <li class="ng-binding">Encriptación de las comunicaciones entre el dispositivo del
                                    usuario y
                            ...
                            <p class="ng-binding">
                                ...
                                otros motivos, los datos ya no sean necesarios para los fines que fueron
                                recogidos.<br><br>
                                En determinadas circunstancias, podrás solicitar la limitación del tratamiento de tus
                                datos,
                            ...
                            <p class="ng-binding" id="impor">
                                ...
                                que
                                utilice para recabar datos personales de sus clientes, tanto si se realiza en soporte
                                papel
                                ...
                                con
                                las obligaciones legales y atender las posibles responsabilidades que pudieran derivar
                                del
                                ...
                                Asimismo, solicitamos su autorización para ofrecerle productos y servicios relacionados
                                con
