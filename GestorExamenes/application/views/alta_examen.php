                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="tituloexamen">
                                TITULO EXAMEN
                                <input id="tituloexamen" type="text" name="tituloexamen" class="form-control" placeholder="Titulo examen"
                                       required autofocus>
                            </label>
                        </div>
                        <div class="form-group">
                            <label for="curso">
                                CURSO
                                <input id="curso" type="text" name="curso" class="form-control" placeholder="Curso" required>
                            </label>
                        </div>
                        <div class="form-group">
                            <label for="asignatura">
                                ASIGNATURA
                                <input id="asignatura" type="text" name="asignatura" class="form-control" placeholder="Asignatura" required>
                            </label>
                        </div>
                        <div class="form-group">
